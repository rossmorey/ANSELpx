...
Photo.create( title: "Manzanar Portrait Series Young Man", description: "Tom Kobayashi, Landscape (looking at camer,
height: ,
width:
)
.",
...
Photo.create( title: "Bristlecone Pine", description: "The pictures are extraordinarily fine and impressive. I hope before this session of Congress adjourns the John Muir National Park in the Kings Canyon area will be a legal fact. Then we can be sure that your descendants and mine will be able to take as beautiful pictures as you have taken—that is, provided they have your skill and artistry.",
  ...
  thumbnail_url: "http://res.cloudinary.com/dhorsi7vf/image/upload/c_scale,h_320/v1473082909/055_wjfrhp.jpg",
  user_id: 3,
  height: ,
  width:
)
...
Photo.create(
  ...
  thumbnail_url: "http://res.cloudinary.com/dhorsi7vf/image/upload/c_scale,h_320/v1473082956/104_ti1nzn.jpg",
  user_id: 5,
  height: ,
  width:
)
...
Photo.create(
  ...
  thumbnail_url: "http://res.cloudinary.com/dhorsi7vf/image/upload/c_scale,h_320/v1473082957/106_r2iuan.jpg",
  user_id: 5,
  height: ,
  width:
)
...
Photo.create(
  ...
  thumbnail_url: "http://res.cloudinary.com/dhorsi7vf/image/upload/c_scale,h_320/v1473082957/107_be3fzk.jpg",
  user_id: 5,
  height: ,
  width:
)
...
Photo.create(
  ...
  thumbnail_url: "http://res.cloudinary.com/dhorsi7vf/image/upload/c_scale,h_320/v1473082957/109_rwrthj.jpg",
  user_id: 6,
  height: ,
  width:
)
...
Photo.create( title: "Ruins", description: "Center for Creative Photography, University of Arizona: Gift of Arizona Highways magazine.",
  ...
  thumbnail_url: "http://res.cloudinary.com/dhorsi7vf/image/upload/c_scale,h_320/v1473082958/112_zoided.jpg",
  user_id: 6,
  height: ,
  width:
)
...
Photo.create(
  ...
  thumbnail_url: "http://res.cloudinary.com/dhorsi7vf/image/upload/c_scale,h_320/v1473082958/115_h3ayb2.jpg",
  user_id: 6,
  height: ,
  width:
)
...
Photo.create(
  ...
  thumbnail_url: "http://res.cloudinary.com/dhorsi7vf/image/upload/c_scale,h_320/v1473125435/162_pmiwux.jpg",
  user_id: 8,
  height: ,
  width:
)
...
Photo.create( title: "Glacier National Park", description: "Going to the Sun Road.",
  ...
  thumbnail_url: "http://res.cloudinary.com/dhorsi7vf/image/upload/c_scale,h_320/v1473125470/170_y15j5o.jpg",
  user_id: 8,
  height: ,
  width:
)
...
Photo.create(
  ...
  thumbnail_url: "http://res.cloudinary.com/dhorsi7vf/image/upload/c_scale,h_320/v1473125800/186_fvka6a.jpg",
  user_id: 9,
  height: ,
  width:
)
